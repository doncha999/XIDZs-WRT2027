...
ln -sf /etc/openclash/core/clash_meta /etc/openclash/clash" "files/etc/uci-defaults/99-init-settings.sh" || error_msg "Error: Failed to add symbolic links to uci-defaults"
}
