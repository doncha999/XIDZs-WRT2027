...
luci-app-poweroffdevice luci-app-ramfree luci-app-tinyfm luci-app-ttyd luci-app-mactodong modeminfo modeminfo-qmi luci-app-modeminfo automodem modeminfo-serial-dell modeminfo-serial-telit luci-app-mmconfig modemband luci-app-modemband podkop luci-app-podkop luci-theme-routerich"
